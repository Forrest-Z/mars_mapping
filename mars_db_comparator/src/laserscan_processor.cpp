...
void LaserscanProcessor::processLaserscan(const sensor_msgs::LaserScan& scan_msg,
...
void LaserscanProcessor::convertLaserScanToPCLPointCloud(const sensor_msgs::LaserScan& scan_msg,
                                                        pcl::PointCloud<pcl::PointXYZ>::Ptr& scan_cloud)
{
